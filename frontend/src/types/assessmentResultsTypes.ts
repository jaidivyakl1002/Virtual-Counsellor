// Assessment result status and priority enums
...
// Type definitions for assessment results data structure
...
export interface GitHubAnalysis {
  technical_proficiency: Record<string, SkillLevel>;
...
export interface SkillGapAnalysis {
  current_skills: Record<string, SkillLevel>;
...
export interface CareerOptimizationData {
...
export interface OpportunityMatcherData {
...
// Props interface for the AssessmentResults root component
export interface AssessmentResultsProps {
  // Core assessment data
  assessmentData: AssessmentResultsResponse;
  ...
  onOpportunityApply?: (opportunityId: string, opportunity: MatchedOpportunity) => void;
  onDownloadReport?: (format: 'pdf' | 'json') => void;
  onShareResults?: (platform: 'linkedin' | 'email' | 'copy') => void;
  ...
  theme?: 'light' | 'dark';
  compactView?: boolean;
  sectionsToShow?: ('profile' | 'market' | 'skills' | 'career' | 'opportunities')[];
...
export const defaultAssessmentResultsProps: Partial<AssessmentResultsProps> = {

...
class LangSmithConfig:
    ...
    def setup_environment():
        ...
        if not api_key:
            logger.warning("LANGCHAIN_API_KEY not found in environment variables. Please check your .env file.")
            return False
    ...
    def create_client() -> Client:
        ...
        try:
            ...
            api_key = os.getenv("LANGCHAIN_API_KEY")
            if not api_key:
                logger.error("LANGCHAIN_API_KEY not found. Cannot create LangSmith client.")
                return None
    ...
    def create_tracer(project_name: str = None) -> LangChainTracer:
        ...
        try:
            tracer = LangChainTracer(project_name=project_name or "career-counselor-system")

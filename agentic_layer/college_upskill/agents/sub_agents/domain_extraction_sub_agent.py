...
class DomainExtractionOutput(BaseModel):
    ...
    specific_domains: List[str] = Field(description="Specific domains from student profile")
    intermediate_domains: List[str] = Field(description="Bridge domains connecting to market categories")
    broad_market_categories: List[str] = Field(description="Broad market categories for trend analysis")
    domain_hierarchy: Dict[str, Dict[str, List[str]]] = Field(description="Mapping between domain levels")
...
class DomainExtractionSubAgent:
    ...
    def __init__(self, llm_model):
        ...
        self.prompt = PromptTemplate(
            input_variables=["student_profile", "education_field", "skills", "experience", "interests"],
...
Focus on the student's actual background while identifying realistic market connections."""
    ...
    def extract_domains(self, student_profile: str, education_field: str, 
                       skills: List[str], experience: str, interests: str) -> Dict[str, Any]:

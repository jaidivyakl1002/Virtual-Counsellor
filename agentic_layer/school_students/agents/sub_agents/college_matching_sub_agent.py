...
class CollegeMatchingOutput(BaseModel):
    ...
    matched_colleges: List[Dict[str, Any]] = Field(description="Colleges matched to student profile")
    ranking_analysis: Dict[str, Any] = Field(description="Ranking-based analysis and recommendations")
    geographic_distribution: Dict[str, List[str]] = Field(description="Region-wise college options")
    admission_probability: Dict[str, str] = Field(description="Probability assessment for different colleges")
    next_steps: List[str] = Field(description="Immediate actions for college applications")
...
class CollegeMatchingSubAgent:
    ...
    def __init__(self, llm_model):
        ...
        self.college_categories = {
            "Engineering": {
                "Tier1": ["IIT Delhi", "IIT Bombay", "IIT Madras", "IIT Kanpur", "IIT Kharagpur"],
                "Tier2": ["NIT Trichy", "NIT Warangal", "NIT Surathkal", "IIIT Hyderabad", "DTU Delhi"],
                "Private_Premium": ["BITS Pilani", "VIT Vellore", "Manipal Institute", "Thapar University"],
                "Regional_Strong": ["State Engineering Colleges", "Regional Technical Universities"]
            },
            "Medicine": {
                "Premier": ["AIIMS Delhi", "CMC Vellore", "JIPMER Puducherry", "KGMU Lucknow"],
                "Government": ["State Medical Colleges", "Central Universities Medical", "Military Medical"],
                "Private_Established": ["Kasturba Medical", "JSS Medical", "Amrita Medical"],
                "Emerging": ["New Medical Colleges", "Private Medical Universities"]
            },
            "Business": {
                "Top_Tier": ["IIM Ahmedabad", "IIM Bangalore", "IIM Calcutta", "ISB Hyderabad"],
            ...
            "Liberal_Arts": {
                "Premium": ["Ashoka University", "O.P. Jindal", "Christ University", "Symbiosis"],
        ...
        self.prompt = PromptTemplate(
            input_variables=["student_profile", "career_goals", "academic_profile", "preferences", "constraints"],
...
{format_instructions}"""
    ...
    def match_colleges(self, student_profile: str, career_goals: str, 
                      academic_profile: str, preferences: str, 

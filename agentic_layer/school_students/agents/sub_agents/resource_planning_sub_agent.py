...
class ResourcePlanningOutput(BaseModel):
    ...
    financial_planning: Dict[str, Any] = Field(description="Detailed financial requirements and options")
    study_resources: Dict[str, List[str]] = Field(description="Specific study materials and tools needed")
    support_system_requirements: List[str] = Field(description="Human resources and mentorship needs")
    technology_requirements: List[str] = Field(description="Digital tools and technology needs")
    alternative_resource_options: Dict[str, List[str]] = Field(description="Budget-friendly alternatives")
...
class ResourcePlanningSubAgent:
    ...
    def __init__(self, llm_model):
        ...
        self.prompt = PromptTemplate(
            input_variables=["student_profile", "career_pathway", "financial_context", "location_context", "grade_timeline"],
...
{format_instructions}"""
    ...
    def generate_resource_plan(self, student_profile: str, career_pathway: str, 
                              financial_context: str, location_context: str, 
                              grade_timeline: str) -> Dict[str, Any]:
